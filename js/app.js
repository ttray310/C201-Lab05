...
function sumArray() { //eslint-disable-line
  ...
  let arrayReport = `${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${arraySum} is their sum.`;
  // console.log(arrayReport);

  return [arraySum, arrayReport];
}
...
function multiplyArray() { //eslint-disable-line
  ...
  let arrayMulti = multiply((multiply(testArray[0], testArray[1])[0]), testArray[2])[0];
